...
/**
 * Helper class for showing and canceling notes reminder
 * notifications.
 * <p>
 * This class makes heavy use of the {@link NotificationCompat.Builder} helper
 * class to create notifications in a backward-compatible way.
 */
public class NotesReminderNotification {
    /**
     * The unique identifier for this type of notification.
     */
    private static final String NOTIFICATION_TAG = "NotesReminder";
     ...
     * presentation of notes reminder notifications. Make
     * sure to follow the
